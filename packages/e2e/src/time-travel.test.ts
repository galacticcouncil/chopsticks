import { getCurrentTimestamp, getSlotDuration } from '@galacticcouncil/chopsticks-core/utils/index.js'
import { timeTravel } from '@galacticcouncil/chopsticks-core/utils/time-travel.js'
